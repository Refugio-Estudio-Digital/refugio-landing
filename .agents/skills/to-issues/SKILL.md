---
name: to-issues
description: Desglosa un plan, especificación o PRD en tickets de Kanban independientes utilizando "vertical slices" (tracer bullets). Úsalo para convertir un PRD en tareas de ejecución técnica con formato de Card de Planner de Refugio.
---

# To Issues (Refugio | Estudio Digital)

Break a plan into independently-grabbable issues using vertical slices (tracer bullets) and the "Refugio" workflow.
...
- ¿Las dependencias reflejan el flujo lógico de "Ascenso Ligero"?
- ¿Debemos asignar alguna tarea específicamente a Giuliana (Junior)?
...
- Bloqueado por: [ID o Título] / "Ninguno - Ascenso inmediato".
</issue-template>
